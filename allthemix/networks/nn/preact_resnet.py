"""PreAct-ResNet feature networks."""
...
class PreActResNetNN(nn.Module):
...
def preact_resnet18_nn(in_channels: int = 3) -> PreActResNetNN:
    return PreActResNetNN(block_sizes=(2, 2, 2, 2), in_channels=in_channels)
